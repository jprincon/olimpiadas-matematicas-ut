...
uses
  ...
  Datasnap.DSHTTP, uMetodosServidor, System.JSON, Data.DBXCommon;
...
procedure TWebModule1.DSServerClass1GetClass(DSServerClass: TDSServerClass;
  var PersistentClass: TPersistentClass);
begin
  PersistentClass := uMetodosServidor.TOlimpiadas;
end;
...
begin
  if SameText(TagString, 'urlpath') then
    ...
    ReplaceText := uMetodosServidor.TOlimpiadas.ClassName
