...
export class VerPruebaComponent implements OnInit {
  ...
  leerPreguntas() {
    ...
    const idPrueba = this.prueba.idprueba;
    const idUsuario = localStorage.getItem(LS_USUARIO).toString();
    this.genService.getPreguntasPrueba(idPrueba, idUsuario).subscribe((rPreguntas: any) => {
